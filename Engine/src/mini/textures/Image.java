...
//    protected int mipOffset = 0;
    ...
    public boolean equals(Object other) {
        ...
        return this.getFormat() == that.getFormat()
               && this.getWidth() == that.getWidth() && this.getHeight() == that.getHeight()
               && (this.getData() == null || this.getData().equals(that.getData()) && (
                this.getData() != null || that.getData() == null && (this.getMipMapSizes() == null
                                                                     || Arrays.equals(
                        this.getMipMapSizes(), that.getMipMapSizes()) && (this.getMipMapSizes()
                                                                          != null ||
                                                                          that.getMipMapSizes()
                                                                          == null
                                                                          && this.getMultiSamples()
                                                                             == that.getMultiSamples()))));
    }
