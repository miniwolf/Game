 ...
 * (using {@link #save(String) } or
 * a .properties file (using {@link #save(OutputStream) }.
 */
public final class ApplicationSettings extends HashMap<String, Object> {
     ...
     *
     * @see AppSettings#setRenderer(String)
     */
     ...
     *
     * @see AppSettings#setAudioRenderer(String)
     */
     ...
     */
    public ApplicationSettings(boolean loadDefaults) {
        if (loadDefaults) {
            putAll(defaults);
        }
    }
     ...
     */
    public void copyFrom(ApplicationSettings other) {
        this.putAll(other);
    }

    /**
     * Same as {@link #copyFrom(mini.system.AppSettings) }, except
     ...
     *              (Default: not set)
     */
    public void setCustomRenderer(Class<? extends ApplicationContext> clazz) {
     ...
     * </ul>
     *
     * @param audioRenderer (Default: LWJGL)
     */
     ...
     *
     * @see #setSettingsDialogImage(String)
     */
     ...
     * disabled otherwise.
     *
     * @param gammaCorrection (Default : true)
     */
