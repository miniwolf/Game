...
public abstract class BoundingVolume implements Cloneable, Collidable {
    ...
    /**
     * <code>transform</code> alters the location of the bounding volume by a rotation, translation
     * and a scalar.
     *
     ...
     *
     * @param store where to store the cloned information. if null or wrong class,
     ...
     * @return Whether the volume intersects the given bounding box.
     */
