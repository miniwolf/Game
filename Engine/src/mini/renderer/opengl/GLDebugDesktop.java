...
public class GLDebugDesktop extends GLDebugES implements GL2, GL3, GL4 {
    ...
    public void glCompressedTexImage3D(int target, int level, int internalformat, int width,
                                       int height, int depth, int border, ByteBuffer data) {
        gl2.glCompressedTexImage3D(target, level, internalformat, width, height, depth, border,
                                   data);
        checkError();
    }
    ...
    public void glCompressedTexSubImage3D(int target, int level, int xoffset, int yoffset,
                                          ...
                                          ByteBuffer data) {
        gl2.glCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height,
                                      depth, format, data);
        checkError();
    }
    ...
    public void glTexImage3D(int target, int level, int internalFormat, int width, int height,
        ...
        gl2.glTexImage3D(target, level, internalFormat, width, height, depth, border, format, type,
                         data);
        checkError();
    }
    ...
    public void glTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset,
                                ...
                                ByteBuffer data) {
        gl2.glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format,
                            type, data);
        checkError();
    }
