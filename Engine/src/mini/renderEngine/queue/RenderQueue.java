...
public class RenderQueue {
     ...
     * via {@link Spatial#setQueueBucket(RenderQueue.Bucket) }.
     */
    public enum Bucket {
        /**
     ...
     *  <ul>
     *  <li>Bucket.Opaque: {@link OpaqueComparator} which sorts
     *                     by material first and front to back within the same material.
     *  <li>Bucket.Transparent: {@link TransparentComparator} which
     *                     sorts purely back to front by leading bounding edge with no material sort.
     *  <li>Bucket.Translucent: {@link TransparentComparator} which
     *                     sorts purely back to front by leading bounding edge with no material sort. this bucket is rendered after post processors.
     *  <li>Bucket.Sky: {@link NullComparator} which does no sorting
     *                     at all.
     *  <li>Bucket.Gui: {@link GuiComparator} sorts geometries back to
