...
public class RenderState {
     ...
     */
    public void setCustomBlendFactors(BlendFunc sfactorRGB, BlendFunc dfactorRGB,
                                      BlendFunc sfactorAlpha, BlendFunc dfactorAlpha) {
     ...
     * @see RenderState#setDepthFunc(RenderState.TestFunction)
     */
    ...
    public int contentHashCode() {
        if (cachedHashCode == -1) {
            ...
            hash = 79 * hash + (this.blendEquationAlpha != null ?
                                this.blendEquationAlpha.hashCode() : 0);
            ...
            hash = 79 * hash + (this.frontStencilStencilFailOperation != null ?
                                this.frontStencilStencilFailOperation.hashCode() : 0);
            hash = 79 * hash + (this.frontStencilDepthFailOperation != null ?
                                this.frontStencilDepthFailOperation.hashCode() : 0);
            hash = 79 * hash + (this.frontStencilDepthPassOperation != null ?
                                this.frontStencilDepthPassOperation.hashCode() : 0);
            hash = 79 * hash + (this.backStencilStencilFailOperation != null ?
                                this.backStencilStencilFailOperation.hashCode() : 0);
            hash = 79 * hash + (this.backStencilDepthFailOperation != null ?
                                this.backStencilDepthFailOperation.hashCode() : 0);
            hash = 79 * hash + (this.backStencilDepthPassOperation != null ?
                                this.backStencilDepthPassOperation.hashCode() : 0);
            hash = 79 * hash + (this.frontStencilFunction != null ?
                                this.frontStencilFunction.hashCode() : 0);
            hash = 79 * hash + (this.backStencilFunction != null ?
                                this.backStencilFunction.hashCode() : 0);
    ...
    public RenderState copyMergedTo(RenderState additionalState, RenderState state) {
        ...
        if (additionalState.applyStencilTest) {
            ...
            state.frontStencilStencilFailOperation
                    = additionalState.frontStencilStencilFailOperation;
    ...
    public String toString() {
        return "RenderState[\n"
               ...
               + (blendMode.equals(BlendMode.Custom) ?
                  "\ncustomBlendFactors=(" + sfactorRGB + ", " + dfactorRGB + ", " + sfactorAlpha
                  + ", " + dfactorAlpha + ")" : "")
               + "\n]";
    }
}
