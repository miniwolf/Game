...
public class NativeObjectManager {
    ...
    private void deleteNativeObject(Object rendererObject, NativeObject obj, NativeObjectRef ref,
        ...
        if (deleteGL) {
            if (obj.getId() <= 0) {
                logger.log(Level.WARNING, "Object already deleted: {0}",
                ...
                if (logger.isLoggable(Level.FINEST)) {
                    logger.log(Level.FINEST, "Deleted: {0}",
                               obj.getClass().getSimpleName() + "/" + id);
                }
    ...
    public void deleteUnused(Object rendererObject) {
        ...
        if (removed >= 1) {
            logger.log(Level.FINE,
                       "NativeObjectManager: {0} native objects were removed from native", removed);
        }
    }
