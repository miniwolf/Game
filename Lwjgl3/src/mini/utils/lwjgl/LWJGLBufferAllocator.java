package mini.utils.lwjgl;

import mini.utils.BufferAllocator;
...
public class LWJGLBufferAllocator implements BufferAllocator {
    ...
    public static final String PROPERTY_CONCURRENT_BUFFER_ALLOCATOR
            = "mini.lwjgl3.ConcurrentBufferAllocator";
    ...
    static class Deallocator extends PhantomReference<ByteBuffer> {
        ...
        Deallocator(final ByteBuffer referent, final ReferenceQueue<? super ByteBuffer> queue,
                    final Long address) {
    ...
    static class ConcurrentDeallocator extends Deallocator {
        ...
        ConcurrentDeallocator(final ByteBuffer referent,
                              final ReferenceQueue<? super ByteBuffer> queue,
